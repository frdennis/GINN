...
class SLoader():
    ...
    def projection(self):
        ...
        Xe = self.x_e * mas_to_rad * self.distance * pc_to_au
        Ye = self.y_e * mas_to_rad * self.distance * pc_to_au

        self.x = M_inv[0,0] * (X) + M_inv[0,1] * Y
        self.y = M_inv[1,0] * (X) + M_inv[1,1] * Y

        self.x_e = M_inv[0,0] * (Xe) + M_inv[0,1] * Ye
        self.y_e = M_inv[1,0] * (Xe) + M_inv[1,1] * Ye
